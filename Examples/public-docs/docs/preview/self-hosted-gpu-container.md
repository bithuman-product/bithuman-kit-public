...
- **Integration Guide**: See [Custom GPU Endpoint Integration](https://github.com/bithuman/public-bithuman-examples/tree/main/public-docs/examples/cloud/expression#%EF%B8%8F-example-3-custom-gpu-endpoint)
