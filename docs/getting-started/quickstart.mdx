...
<Tip>
**Source, changelog, and issue tracker** for the `bithuman` PyPI package live at [bithuman-python-sdk-public](https://github.com/bithuman-product/bithuman-python-sdk-public). The runtime source is private (signing material is baked in), but the public repo mirrors the README + changelog and is where to file bugs or feature requests.
</Tip>
