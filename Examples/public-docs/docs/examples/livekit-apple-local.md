...
```bash
pip install https://github.com/bithuman/public-bithuman-examples/releases/download/v0.1/bithuman_voice-1.3.2-py3-none-any.whl
```
...
📁 **[View source code on GitHub](https://github.com/bithuman/public-bithuman-examples/blob/main/public-docs/examples/agent-livekit-apple-local.py)**
...
🚀 **[Complete macOS Offline Example →](https://github.com/bithuman/public-bithuman-examples/tree/main/public-macos-offline-example)**
