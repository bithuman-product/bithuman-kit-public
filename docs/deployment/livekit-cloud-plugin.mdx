...
<Tip>
The Expression model runs on bitHuman Cloud (default), your own NVIDIA GPU ([Self-Hosted GPU](/deployment/self-hosted-gpu)), or natively on Apple Silicon M3+ ([Expression on macOS](/examples/apple-expression)).
</Tip>
