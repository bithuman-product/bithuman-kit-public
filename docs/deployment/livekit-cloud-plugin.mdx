...
<Steps>
  ...
  <Step title="Get your API Secret">
    Go to [imaginex.bithuman.ai](https://imaginex.bithuman.ai/#developer) and copy your **API Secret**.
  </Step>
  <Step title="Find your Agent ID">
    Click on any agent card in [your dashboard](https://imaginex.bithuman.ai). The **Agent Settings** dialog shows your Agent ID (e.g., `A78WKV4515`).
...
|-----------|------|----------|-------------|
| `avatar_id` | string | Yes* | Agent ID from the ImagineX dashboard |
...
| Problem | Solution |
|---------|----------|
| Authentication errors | Verify API secret at [imaginex.bithuman.ai](https://imaginex.bithuman.ai/#developer) |
