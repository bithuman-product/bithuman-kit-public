...
- **[On-Device Apple Silicon (Swift SDK)](/swift-sdk/overview)** — `bitHumanKit` Swift Package for Mac/iPad/iPhone. Drop-in voice + lip-synced avatar; runs locally. See the [Swift SDK quickstart](/swift-sdk/quickstart) for the 10-minute integration.

## Quick Start

<Note>
Building a **Mac/iPad/iPhone app**? Skip straight to the
[**Swift SDK quickstart →**](/swift-sdk/quickstart). The snippets
below are for the **Python SDK / REST API / Docker** path.
</Note>
