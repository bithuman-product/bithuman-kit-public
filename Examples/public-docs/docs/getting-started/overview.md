...
For complete setup instructions, see our **[README.md](https://github.com/bithuman/public-bithuman-examples/blob/main/public-docs/README.md)** which covers:
...
1. **Read the [README](https://github.com/bithuman/public-bithuman-examples/blob/main/public-docs/README.md)** for complete setup
...
4. **Browse [Source Code](https://github.com/bithuman/public-bithuman-examples/tree/main/public-docs)** on GitHub
...
*For detailed instructions, troubleshooting, and advanced features, see our **[README.md](https://github.com/bithuman/public-bithuman-examples/blob/main/public-docs/README.md)*** 