...
<Steps>
  ...
  <Step title="Get an Expression .imx">
    ...
    Build one with `bithuman pack` (see the [Python SDK README](https://github.com/bithuman-product/bithuman-python-sdk#packing-at-different-resolutions)) or download a pre-packed model from your dashboard.
