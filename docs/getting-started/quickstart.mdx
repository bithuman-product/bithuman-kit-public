...
- **Expression** on-device: macOS 14+ on **Apple Silicon M5 or later**, 16 GB RAM. Elsewhere, use the [self-hosted GPU deployment](/deployment/self-hosted-gpu) on Linux + NVIDIA.
