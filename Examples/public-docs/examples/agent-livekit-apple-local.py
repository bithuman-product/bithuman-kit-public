...
# Instructions:
# First, install bithuman-voice from `pip install https://github.com/bithuman/public-bithuman-examples/releases/download/v0.1/bithuman_voice-1.3.2-py3-none-any.whl`
