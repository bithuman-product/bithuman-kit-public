...
The full reference compose at [`bithuman-examples/expression-selfhosted`](https://github.com/bithuman-product/bithuman-examples/tree/main/expression-selfhosted) ships with all of these defaults.
